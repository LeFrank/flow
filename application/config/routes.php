...
$route['team-member/(:num)/edit'] = 'teamMember/edit/$1';
$route['team-member/(:num)/update'] = 'teamMember/update/$1';
$route['team-member/(:num)/delete'] = 'teamMember/delete/$1';
$route['events'] = 'event/index';
$route['event/capture'] = 'event/capture';
$route['event/(:num)/edit'] = 'event/edit/$1';
$route['event/(:num)/update'] = 'event/update/$1';
$route['event/(:num)/delete'] = 'event/delete/$1';
