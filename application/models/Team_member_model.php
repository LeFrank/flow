...
//        $this->load->model("note_tag_model");
     ...
     * @return type
     */
    public function capture_team_member() {
...
//        }
     ...
     * @return null
     */
    public function getTeamMembers($limit = null, $offset = 0, $count = false, $orderField="created_date" , $orderDirection="desc") {
...
//        echo $this->db->last_query();
    ...
    public function getTeamMembersByIds($userId, $team_memberIds) {
        if ($userId == null) {
            return null;
        }
        if ($noteIds == null) {
        ...
        $this->db->where_in('id', $team_memberIds);
        $query = $this->db->get_where($this->tn, array('created_by' => $userId), 100);
        return $query->result_array();
    }

    public function searchTeam_members($limit = null, $offset = 0, $count = false) {
    ...
    public function searchTeamMembersCriteria($limit = null, $offset = 0, $count = false , $text= null, $start_date = null, $end_date = null){
