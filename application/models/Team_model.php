...
//        }
     ...
     * @return null
     */
    public function getTeams($limit = null, $offset = 0, $count = false , $orderField="created_date" , $orderDirection="desc") {
...
//        echo $this->db->last_query();
    ...
    public function getTeamsByIds($teamIds) {
        if(null == $teamIds){
            return null;
        }
        $this->db->order_by("created_date", "desc");
        $this->db->where_in('id', $teamIds);
        $query = $this->db->get_where($this->tn);
        return $query->result_array();
    }

    public function searchTeams($limit = null, $offset = 0, $count = false) {
    ...
    public function searchTeamsCriteria($limit = null, $offset = 0, $count = false , $text= null, $start_date = null, $end_date = null){
    ...
    public function update() {
        $note = $this->getTeam( $this->input->post('id'));
